    ...
    <table width="100%">
            ...
            <td width="50%" valign="top">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="number" name="validezDias" value="{{ $cotizacion->validezDias }}" min="1" max="365" required></td>
                    </tr>
                    <tr>
                        <td><label>Observaciones:</label></td>
                        <td><textarea name="observaciones" rows="3" cols="40" placeholder="Observaciones adicionales...">{{ $cotizacion->observaciones }}</textarea></td>
                    </tr>
                </table>
            </td>
            <td width="50%" valign="top">
                ...
                <div id="productos-container">
                    ...
                    <div class="producto-item">
                        <table width="100%">
                            <tr>
                                <td>
                                    <select name="articulos[{{ $index }}][idArticuloMarca]" class="articulo-select" required onchange="actualizarPrecio(this, {{ $index }})">
                ...
                <table border="1" cellpadding="5" cellspacing="0">
                    <tr>
                        <th>Subtotal</th>
                        <td id="subtotal">$ {{ number_format($cotizacion->subtotal, 2) }}</td>
                    </tr>
                    <tr>
                        <th>IVA (21%)</th>
                        <td id="iva">$ {{ number_format($cotizacion->iva, 2) }}</td>
                    </tr>
                    <tr>
                        <th>Total</th>
                        <td id="total" style="font-weight: bold;">$ {{ number_format($cotizacion->total, 2) }}</td>
                    </tr>
                </table>
            </td>
        </tr>
        <tr>
            <td colspan="2" align="center">
                ...
                <a href="{{ route('cotizaciones.show', $cotizacion->idCotizacion) }}">Cancelar</a>
            </td>
        </tr>
    </table>
</form>
